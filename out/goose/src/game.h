...
/** game_add_space sets a game-space pointer to NULL to space. This increases the number of game spaces.
*
...
/** game_get_player_location gets the position of a player in the game. Unused because player module has been implemented.
*
* @param {Game*} - game;
...
/** game_get_object_location gets the position of an object in the game.
*
* @param {Game*} - game;
* @return {Id} - Returns a pointer;
*/
...
/** game_get_last_command returns last command introduced by keyboard, in order to detect if it is a valid or non-valid one.
*
* @param {Game*} - game;
* @return {T_Command} - Returns a cmd id value;
*/
...
/** game_set_player sets a new object.
*
