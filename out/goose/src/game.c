...
/** game_callback_unknown informs that command introduced is unknown by the game.
*
* @param {Game*} - game;
...
/** game_callback_exit defines the next movement to exit.
*
* @param {Game*} - game;
* @return {void} - Do not return nothing;
*/
...
/** game_callback_next sets the player's new position if n or next is introduced by keyboard.
*
* @param {Game*} - game;
* @return {void} - Do not return nothing;
*/
...
/** game_callback_back sets the player's new position to the one before current.
*
* @param {Game*} - game;
* @return {void} - Do not return nothing;
*/
...
/** game_callback_take asigns a object to a player and removes it from the current cell.
*
* @param {Game*} - game;
* @return {void} - Do not return nothing;
*/
...
/** game_callback_drop asigns a object to a cell and removes it from the player.
*
* @param {Game*} - game;
* @return {void} - Do not return nothing;
*/
...
/** game_get_space_id_gets the id of an space cell.
*
...
void game_set_dice( Game *game, Die *d ) {
...
void game_callback_roll( Game *game ) {
  int n;
  char buff[30] = "";
  n = die_roll( game->dice );

  sprintf( buff, "%d", n );
  cmd_set_ans( game->last_cmd, 0, buff );
}
