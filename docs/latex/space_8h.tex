...
\begin{DoxyCompactList}\small\item\em creates a new sapce \end{DoxyCompactList}\end{DoxyCompactItemize}
\begin{Indent}\textbf{ space\+\_\+destroy}\par
{\em sets to null a space area.
