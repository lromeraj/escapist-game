...
void \hyperlink{game_8h_ac43df8654f7e438bca33449c0de67aa7}{game\+\_\+get\+\_\+spaces} (\hyperlink{struct__Game}{Game} $\ast$game, int max, \hyperlink{space_8h_a67533ffc2b70463baecc38fb0629bbfc}{Space} $\ast$$\ast$spaces, int $\ast$total)
\begin{DoxyCompactList}\small\item\em get spaces \end{DoxyCompactList}\item 
void \hyperlink{game_8h_a00ec1903ad0212873b64668de5984f0d}{game\+\_\+get\+\_\+links} (\hyperlink{struct__Game}{Game} $\ast$game, int max, \hyperlink{struct__Link}{Link} $\ast$$\ast$links, int $\ast$total)
\begin{DoxyCompactList}\small\item\em get links \end{DoxyCompactList}\item 
void \hyperlink{game_8h_a59eac3fe8bb037c712ca0957b798cf72}{game\+\_\+get\+\_\+objects} (\hyperlink{struct__Game}{Game} $\ast$game, int max, \hyperlink{object_8h_a7f8bbcda919b65ce67f92fba08e0212f}{Object} $\ast$$\ast$objs, int $\ast$total)
\begin{DoxyCompactList}\small\item\em sets a new die \end{DoxyCompactList}\item 
...
\hyperlink{types_8h_a32c27cc471df37f4fc818d65de0a56c4}{S\+T\+A\+T\+US} \hyperlink{game_8h_a63b8fadde2c72953a6264d972bbf9871}{game\+\_\+clean} (\hyperlink{struct__Game}{Game} $\ast$game)
\begin{DoxyCompactList}\small\item\em clean all the information used by the game \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{game.\+h@{game.\+h}!game\+\_\+get\+\_\+spaces@{game\+\_\+get\+\_\+spaces}}
\index{game\+\_\+get\+\_\+spaces@{game\+\_\+get\+\_\+spaces}!game.\+h@{game.\+h}}
\subsubsection{\texorpdfstring{game\+\_\+get\+\_\+spaces()}{game\_get\_spaces()}}
{\footnotesize\ttfamily void game\+\_\+get\+\_\+spaces (\begin{DoxyParamCaption}\item[{\hyperlink{struct__Game}{Game} $\ast$}]{game,  }\item[{int}]{max,  }\item[{\hyperlink{space_8h_a67533ffc2b70463baecc38fb0629bbfc}{Space} $\ast$$\ast$}]{spaces,  }\item[{int $\ast$}]{total }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void game\+\_\+get\+\_\+links (\begin{DoxyParamCaption}\item[{\hyperlink{struct__Game}{Game} $\ast$}]{game,  }\item[{int}]{max,  }\item[{\hyperlink{struct__Link}{Link} $\ast$$\ast$}]{links,  }\item[{int $\ast$}]{total }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void game\+\_\+get\+\_\+objects (\begin{DoxyParamCaption}\item[{\hyperlink{struct__Game}{Game} $\ast$}]{game,  }\item[{int}]{max,  }\item[{\hyperlink{object_8h_a7f8bbcda919b65ce67f92fba08e0212f}{Object} $\ast$$\ast$}]{objs,  }\item[{int $\ast$}]{total }\end{DoxyParamCaption})}
...
\index{game.\+h@{game.\+h}!game\+\_\+clean@{game\+\_\+clean}}
\index{game\+\_\+clean@{game\+\_\+clean}!game.\+h@{game.\+h}}
\subsubsection{\texorpdfstring{game\+\_\+clean()}{game\_clean()}}
{\footnotesize\ttfamily \hyperlink{types_8h_a32c27cc471df37f4fc818d65de0a56c4}{S\+T\+A\+T\+US} game\+\_\+clean (\begin{DoxyParamCaption}\item[{\hyperlink{struct__Game}{Game} $\ast$}]{game }\end{DoxyParamCaption})}



clean all the information used by the game 
