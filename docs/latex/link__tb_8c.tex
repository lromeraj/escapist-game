...
\item[\hyperlink{test__test000017}{Test}]creates a Link on an Link \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
The integer -\/1 as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
A null pointer to the created link 
\end{DoxyPostcond}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000018}{Test}]creates a Link on an Link \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
The integer 1 as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
A pointer to the created link 
\end{DoxyPostcond}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000019}{Test}]set an id to a link \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer and an the integer -\/1 as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
An E\+R\+R\+OR 
\end{DoxyPostcond}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000020}{Test}]set an id to a link \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer and an the integer 1 as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000021}{Test}]set a name \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A null link pointer and a name as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
An E\+R\+R\+OR 
\end{DoxyPostcond}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000022}{Test}]set a name \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer and a name as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
A OK 
\end{DoxyPostcond}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000023}{Test}]set the link to \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A null link pointer and a integer as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
An E\+R\+R\+OR 
\end{DoxyPostcond}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000024}{Test}]set the link to \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer and a integer as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
An OK 
\end{DoxyPostcond}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000025}{Test}]set the link from \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A null link pointer and a integer as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000026}{Test}]set the link from \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer and a integer as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000027}{Test}]set link state \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A null link pointer and a integer as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000028}{Test}]set link state \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer and a integer as parameters 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000029}{Test}]Print the link fields \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A null link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
An E\+R\+R\+OR 
\end{DoxyPostcond}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000030}{Test}]Print the link fields \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
An OK 
\end{DoxyPostcond}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000031}{Test}]Gets the link id \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A null link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000032}{Test}]Gets the link id \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000033}{Test}]Gets the id of the field link to \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A null link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000034}{Test}]Gets the id of the field link to \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000035}{Test}]Gets the id of the field link\+\_\+from \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A null link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000036}{Test}]Gets the id of the field link\+\_\+from \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000037}{Test}]Gets the state of the link \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A null link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\begin{DoxyRefDesc}{Test}
\item[\hyperlink{test__test000038}{Test}]Gets the state of the link \end{DoxyRefDesc}
\begin{DoxyPrecond}{Precondition}
A link pointer as parameter 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
