...
\begin{DoxyCompactItemize}
\item 
void \hyperlink{g__engine_8c_a947f9e2e4c31ea006fd0c69072c9abf3}{parse\+\_\+space} (\hyperlink{struct__Game}{Game} $\ast$game, \hyperlink{struct__G__engine}{G\+\_\+engine} $\ast$ge, \hyperlink{struct__Space}{Space} $\ast$sp, int id, int x, int y)
...
{\footnotesize\ttfamily void parse\+\_\+space (\begin{DoxyParamCaption}\item[{\hyperlink{struct__Game}{Game} $\ast$}]{game,  }\item[{\hyperlink{struct__G__engine}{G\+\_\+engine} $\ast$}]{ge,  }\item[{\hyperlink{struct__Space}{Space} $\ast$}]{sp,  }\item[{int}]{id,  }\item[{int}]{x,  }\item[{int}]{y }\end{DoxyParamCaption})}
