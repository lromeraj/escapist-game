...
\begin{DoxyCompactItemize}
\item 
void \hyperlink{g__engine_8c_a947f9e2e4c31ea006fd0c69072c9abf3}{parse\+\_\+space} (Game $\ast$game, G\+\_\+engine $\ast$ge, Space $\ast$sp, int id, int x, int y)
...
{\footnotesize\ttfamily void parse\+\_\+space (\begin{DoxyParamCaption}\item[{Game $\ast$}]{game,  }\item[{G\+\_\+engine $\ast$}]{ge,  }\item[{Space $\ast$}]{sp,  }\item[{int}]{id,  }\item[{int}]{x,  }\item[{int}]{y }\end{DoxyParamCaption})}
